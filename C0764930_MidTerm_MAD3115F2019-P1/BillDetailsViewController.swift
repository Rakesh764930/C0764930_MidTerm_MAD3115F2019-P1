...
var billObject: Bill? = nil
    ...
    override func viewDidLoad() {
        ...
        func setGradientBackground() {
              let colorTop =  UIColor(red: 285.0/255.0, green: 149.0/255.0, blue: 0.0/25.0, alpha: 1.0).cgColor
              let colorBottom = UIColor(red: 255.0/25.0, green: 104.0/255.0, blue: 250.0/25.0, alpha: 1.0).cgColor
