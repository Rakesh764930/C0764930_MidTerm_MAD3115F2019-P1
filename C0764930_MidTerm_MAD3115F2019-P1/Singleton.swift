...
class Singleton : NSObject {
    ...
    func defaultCustomer()  {
        ...
        let m2 = MobileBill(manufacturerName:"Apple", planName:"Postpaid Talk + Messages", phoneNumber:3476956811, internetUsed:6, minutesUsed:124, billAmount:80.00, billId : 5, billType : Bill.bTypes.Mobile, billDate: "Friday, 19 June, 2019")
        ...
        // c u s t o m e r  3
         ...
         let m3 = MobileBill(manufacturerName:"Huwaie", planName:"Prepaid + Postpaid Talk ", phoneNumber:6435354211, internetUsed:6, minutesUsed:124, billAmount:80.00, billId : 5, billType : Bill.bTypes.Mobile, billDate: "Friday, 19 June, 2019")
